...
var bContinue = true;
while( objParent.tagName.toUpperCase() != "BODY" && bContinue)
{
objLeft  += objParent.offsetLeft;
objTop   += objParent.offsetTop;
objParent.offsetParent ? objParent = objParent.offsetParent : bContinue = false;
}
...
document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1px;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Close the Calendar'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content2'></span></td></tr>")
 
if (showToday==1)
{
document.write ("<tr bgcolor=#f0f0f0><td style='padding:5px' align=center><span id='lblToday'></span> | <a href='javascript:dateSelected=0;closeCalendar();' style='"+styleBottom+"'>Clear</a></td></tr>")
}
...
{
var version = 0;
if (checkIEVersion() < 9 && checkIEVersion() > 0) {
  var ie = true;
...
if (showToday==1)
{
document.getElementById("lblToday").innerHTML =	todayString + "<a onmousemove='window.status=\"\"' onmouseout='window.status=\"\"' style='"+styleBottom+"' href='javascript:dateSelected=dateNow;monthSelected=monthNow;yearSelected=yearNow;closeCalendar();'>"+dayName[(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+", " + dateNow + " " + monthName[monthNow].substring(0,3)	+ "	" +	yearNow	+ "</a>"
}
...
var keynum;if (window.event) {keynum = event.keyCode;} else if(e.keyCode) {keynum = e.keyCode;}
if (keynum==27)
{
hideCalendar()
}
